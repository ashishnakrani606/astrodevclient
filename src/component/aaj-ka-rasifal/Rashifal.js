...
import Mesh from "./../../assets/image/Aries.png";
import Vrushbh from "./../../assets/image/Taurus.png";
...
import Pisces from "./../../assets/image/meen.png";
import Scorpio from "./../../assets/image/Scorpio.png";
import Link from "next/link";

const Rashifal = () => {
  const [activerashi, setActiverashi] = useState(1);
  ...
  return (
    <div className="pt-4">
      <div className="container">
        <div className="border-2 rounded-md border-primary-orange">
          <>
            <div className="flex">
              <div
                onClick={(e) => {
                ...
                className={`tab border-r border-b border-primary-orange cursor-pointer ${
                  activerashi === 1 ? "border-b-0" : ""
                }`}
              >
                <Image src={Mesh} alt="" />
              </div>
              <div
                ...
                className={`tab border-r border-b border-primary-orange cursor-pointer ${
                  activerashi === 2 ? "border-b-0" : ""
                }`}
              >
                <Image src={Vrushbh} alt="" />
              </div>
              <div
                onClick={(e) => {
                  e.preventDefault();
              ...
              <div
                ...
                className={`tab border-r border-b border-primary-orange cursor-pointer ${
                  activerashi === 4 ? "border-b-0" : ""
                }`}
              >
                <Image src={Cancer} alt="" />
              </div>
              <div
                onClick={(e) => {
                  e.preventDefault();
              ...
              <div
                ...
                className={`tab border-r border-b border-primary-orange cursor-pointer ${
                  activerashi === 8 ? "border-b-0" : ""
                }`}
              >
                <Image src={Scorpio} alt="" />
              </div>
              ...
              <div
                ...
                className={`tab border-r border-b border-primary-orange cursor-pointer ${
                  activerashi === 9 ? "border-b-0" : ""
                }`}
              >
                <Image src={Sagittarius} alt="" />
              </div>
              <div
                onClick={(e) => {
                  e.preventDefault();
                ...
                className={`tab border-r border-b border-primary-orange cursor-pointer ${
                  activerashi === 10 ? "border-b-0" : ""
                }`}
              >
                <Image src={Capricorn} alt="" />
              </div>
              <div
                onClick={(e) => {
                  e.preventDefault();
                ...
                className={`tab border-r border-b border-primary-orange cursor-pointer ${
                  activerashi === 11 ? "border-b-0" : ""
                }`}
              >
                <Image src={Aquarius} alt="" />
              </div>
              <div
                onClick={(e) => {
                  e.preventDefault();
                ...
                className={`tab border-b border-primary-orange cursor-pointer ${
                  activerashi === 12 ? "border-b-0" : ""
                }`}
              >
                <Image src={Pisces} alt="" />
              </div>
            </div>
          </>
          <div className="flex justify-end font-semibold sm:gap-8 gap-1 border-b">
            {rashiTime.map((item) => (
              <div key={item.id}>
                <div                 
                  className={`!text-primary-black md:px-5 px-1 md:text-base text-sm py-3 cursor-pointer ${
                    activetime === item.id
          ...
          <div className={`${activerashi === 1 ? "block" : "hidden"}`}>
            <div className="py-8 px-4">
              <div className={`${activetime === 1 ? "block" : "hidden"}`}>
                <>
                  ...
                  <p className="md:text-base text-sm">
                    To get your accurate daily horoscope on your phone, download
                    now - AstroSage Kundli App
                  </p>
                </>
              </div>
              <div className={`${activetime === 2 ? "block" : "hidden"}`}>
                ...
                <p className="md:text-base text-sm">
                  {" "}
                  This horoscope is based on your moon sign. Also connect with
                  astrologers on phone or chat to get personalized predictions.
                </p>
              </div>
              <div className={`${activetime === 3 ? "block" : "hidden"}`}>
                <div className="text-center">
                  <h2 className="md:text-3xl text-xl font-bold pb-4">
                    Weekly Love Horoscope (Taurus) / Vrishabha Rashifal
                  </h2>
                  <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                    7 Aug 2023 - 13 Aug 2023
                  </h3>
              ...
              <div className={`${activetime === 4 ? "block" : "hidden"}`}>
                <div className="text-center">
                  <h2 className="md:text-3xl text-xl font-bold pb-4">
                    Vrishabha Masik Rashifal in Hindi
                  </h2>
                  <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                    August, 2023
                  </h3>
                ...
                <div>
                  ...
                  <p className="pb-3">
                    {" "}
                    Aries people will get mixed results this month as both the
                    nodal planets Rahu and Ketu are not present in a favorable
                    house. Rahu is present in the first and Ketu in the seventh
                    house.
                  </p>
                  <p className="pb-3">
                    {" "}
                    Another benefic planet Jupiter is present in the first house
                    and twelfth house along with Rahu. This will not be a good
                    sign for your auspicious results. Venus, the planet
                    responsible for love, is present in the fourth house in a
                    retrograde state, while thi dasha of Venus will start on 8th
                    August 2023 and on 18th August 2023, Venus will rise back.
                    On the other hand, Mercury, th planet responsible for
                    intelligence, will turn retrograde on August 24, 2023. Fro
                    August 18, 2023, Mars, the lord of Aries, will enter the
                    sixth house.
                  </p>
                  <p>
                    {
          ...
          <div className={`${activerashi === 2 ? "block" : "hidden"}`}>
            <div className="py-8 px-4">
              <div className={`${activetime === 1 ? "block" : "hidden"}`}>
                <>
                  <div className="text-center">
                    <h2 className="md:text-3xl text-xl font-bold pb-4">
                      Daily Hindi Horoscope (Taurus) / Vrishabha Rashifal
                    </h2>
                    <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                      Saturday, August 12, 2023
                    </h3>
              ...
              <div className={`${activetime === 4 ? "block" : "hidden"}`}>
                ...
                <div>
                  ...
                  <p className="pb-3">
                    ...
                    August 2023 and on 18th August 2023, Venus will rise back.
                    On the other hand, Mercury, th planet responsible for
                    intelligence, will turn retrograde on August 24, 2023. From
                    August 18, 2023, Mars, the lord of Aries, will enter the
                    sixth house.
                  </p>
                  <p>
          ...
          <div className={`${activerashi === 3 ? "block" : "hidden"}`}>
            <div className="py-8 px-4">
              <div className={`${activetime === 1 ? "block" : "hidden"}`}>
                <>
                  <div className="text-center">
                    <h2 className="md:text-3xl text-xl font-bold pb-4">
                      Daily Hindi Horoscope (Gemini) / Mithun Rashifal
                    </h2>
                    <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                      Saturday, August 12, 2023
                    </h3>
              ...
              <div className={`${activetime === 3 ? "block" : "hidden"}`}>
                <div className="text-center">
                  <h2 className="md:text-3xl text-xl font-bold pb-4">
                    Weekly Love Horoscope (Gemini) / Mithun Rashifal
                  </h2>
                  <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                    7 Aug 2023 - 13 Aug 2023
                  </h3>
              ...
              <div className={`${activetime === 4 ? "block" : "hidden"}`}>
                <div className="text-center">
                  <h2 className="md:text-3xl text-xl font-bold pb-4">
                    Mithun Masik Rashifal in Hindi
                  </h2>
                  <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                    August, 2023
                  </h3>
          ...
          <div className={`${activerashi === 4 ? "block" : "hidden"}`}>
            <div className="py-8 px-4">
              <div className={`${activetime === 1 ? "block" : "hidden"}`}>
                <>
                  <div className="text-center">
                    <h2 className="md:text-3xl text-xl font-bold pb-4">
                      Daily Hindi Horoscope (Cancer)
                    </h2>
                    <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                      Saturday, August 12, 2023
                    </h3>
          ...
          <div className={`${activerashi === 5 ? "block" : "hidden"}`}>
            <div className="py-8 px-4">
              <div className={`${activetime === 1 ? "block" : "hidden"}`}>
                <>
                  <div className="text-center">
                    <h2 className="md:text-3xl text-xl font-bold pb-4">
                      Daily Hindi Horoscope (Leo)
                    </h2>
                    <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                      Saturday, August 12, 2023
                    </h3>
              ...
              <div className={`${activetime === 3 ? "block" : "hidden"}`}>
                <div className="text-center">
                  <h2 className="md:text-3xl text-xl font-bold pb-4">
                    {" "}
                    Weekly Love Horoscope in Hindi (Leo Rashi)
                  </h2>
                  <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                    7 Aug 2023 - 13 Aug 2023
                  </h3>
          ...
          <div className={`${activerashi === 6 ? "block" : "hidden"}`}>
            <div className="py-8 px-4">
              <div className={`${activetime === 1 ? "block" : "hidden"}`}>
                <>
                  <div className="text-center">
                    <h2 className="md:text-3xl text-xl font-bold pb-4">
                      Daily Hindi Horoscope (Virgo)
                    </h2>
                    <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                      Saturday, August 12, 2023
                    </h3>
              ...
              <div className={`${activetime === 3 ? "block" : "hidden"}`}>
                <div className="text-center">
                  <h2 className="md:text-3xl text-xl font-bold pb-4">
                    {" "}
                    Weekly Love Horoscope in Hindi (Virgo)
                  </h2>
                  <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                    7 Aug 2023 - 13 Aug 2023
                  </h3>
              ...
              <div className={`${activetime === 4 ? "block" : "hidden"}`}>
                ...
                <div>
                  ...
                  <p className="pb-3">
                    ...
                    August 2023 and on 18th August 2023, Venus will rise back.
                    On the other hand, Mercury, th planet responsible for
                    intelligence, will turn retrograde on August 24, 2023.
                    FromAugust 18, 2023, Mars, the lord of Aries, will enter the
                    sixth house.
                  </p>
                  <p>
                    {
          ...
          <div className={`${activerashi === 7 ? "block" : "hidden"}`}>
            <div className="py-8 px-4">
              <div className={`${activetime === 1 ? "block" : "hidden"}`}>
                <>
                  <div className="text-center">
                    <h2 className="md:text-3xl text-xl font-bold pb-4">
                      Daily Hindi Horoscope (Libra)
                    </h2>
                    <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                      Saturday, August 12, 2023
                    </h3>
          ...
          <div className={`${activerashi === 8 ? "block" : "hidden"}`}>
            <div className="py-8 px-4">
              <div className={`${activetime === 1 ? "block" : "hidden"}`}>
                <>
                  <div className="text-center">
                    <h2 className="md:text-3xl text-xl font-bold pb-4">
                      Daily Hindi Horoscope (Scorpio)
                    </h2>
                    <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                      Saturday, August 12, 2023
                    </h3>
              ...
              <div className={`${activetime === 3 ? "block" : "hidden"}`}>
                <div className="text-center">
                  <h2 className="md:text-3xl text-xl font-bold pb-4">
                    {" "}
                    Weekly Love Horoscope in Hindi (Scorpio)
                  </h2>
                  <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                    7 Aug 2023 - 13 Aug 2023
                  </h3>
              ...
              <div className={`${activetime === 4 ? "block" : "hidden"}`}>
                <div className="text-center">
                  <h2 className="md:text-3xl text-xl font-bold pb-4">
                    Vrishchika Masik Rashifal in Hindi
                  </h2>
                  <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                    August, 2023
                  </h3>
          ...
          <div className={`${activerashi === 9 ? "block" : "hidden"}`}>
            <div className="py-8 px-4">
              <div className={`${activetime === 1 ? "block" : "hidden"}`}>
                <>
                  <div className="text-center">
                    <h2 className="md:text-3xl text-xl font-bold pb-4">
                      Daily Hindi Horoscope (Sagittarius)
                    </h2>
                    <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                      Saturday, August 12, 2023
                    </h3>
              ...
              <div className={`${activetime === 3 ? "block" : "hidden"}`}>
                <div className="text-center">
                  <h2 className="md:text-3xl text-xl font-bold pb-4">
                    {" "}
                    Weekly Love Horoscope in Hindi (Sagittarius)
                  </h2>
                  <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                    7 Aug 2023 - 13 Aug 2023
                  </h3>
          ...
          <div className={`${activerashi === 10 ? "block" : "hidden"}`}>
            <div className="py-8 px-4">
              <div className={`${activetime === 1 ? "block" : "hidden"}`}>
                <>
                  <div className="text-center">
                    <h2 className="md:text-3xl text-xl font-bold pb-4">
                      Daily Hindi Horoscope (Capricorn) / Makara Rashifal
                    </h2>
                    <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                      Saturday, August 12, 2023
                    </h3>
              ...
              <div className={`${activetime === 3 ? "block" : "hidden"}`}>
                <div className="text-center">
                  <h2 className="md:text-3xl text-xl font-bold pb-4">
                    {" "}
                    Weekly Love Horoscope in Hindi (Capricorn)
                  </h2>
                  <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                    7 Aug 2023 - 13 Aug 2023
                  </h3>
              ...
              <div className={`${activetime === 4 ? "block" : "hidden"}`}>
                <div className="text-center">
                  <h2 className="md:text-3xl text-xl font-bold pb-4">
                    Makara Masik Rashifal in Hindi
                  </h2>
                  <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                    August, 2023
                  </h3>
          ...
          <div className={`${activerashi === 11 ? "block" : "hidden"}`}>
            <div className="py-8 px-4">
              <div className={`${activetime === 1 ? "block" : "hidden"}`}>
                <>
                  <div className="text-center">
                    <h2 className="md:text-3xl text-xl font-bold pb-4">
                      Daily Hindi Horoscope (Aquarius) / Kumbha Rashifal
                    </h2>
                    <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                      Saturday, August 12, 2023
                    </h3>
              ...
              <div className={`${activetime === 3 ? "block" : "hidden"}`}>
                <div className="text-center">
                  <h2 className="md:text-3xl text-xl font-bold pb-4">
                    {" "}
                    Weekly Love Horoscope (Aquarius) / Kumbha Rashifal
                  </h2>
                  <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                    7 Aug 2023 - 13 Aug 2023
                  </h3>
              ...
              <div className={`${activetime === 4 ? "block" : "hidden"}`}>
                <div className="text-center">
                  <h2 className="md:text-3xl text-xl font-bold pb-4">
                    Kumbha Masik Rashifal in Hindi
                  </h2>
                  <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                    August, 2023
                  </h3>
          ...
          <div className={`${activerashi === 12 ? "block" : "hidden"}`}>
            <div className="py-8 px-4">
              <div className={`${activetime === 1 ? "block" : "hidden"}`}>
                <>
                  <div className="text-center">
                    <h2 className="md:text-3xl text-xl font-bold pb-4">
                      Daily Hindi Horoscope (Pisces) / Meena Rashifal
                    </h2>
                    <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                      Saturday, August 12, 2023
                    </h3>
              ...
              <div className={`${activetime === 3 ? "block" : "hidden"}`}>
                <div className="text-center">
                  <h2 className="md:text-3xl text-xl font-bold pb-4">
                    {" "}
                    Weekly Love Horoscope (Pisces) / Meena Rashifal
                  </h2>
                  <h3 className="md:text-xl text-lg text-primary-orange font-semibold pb-5">
                    7 Aug 2023 - 13 Aug 2023
                  </h3>
